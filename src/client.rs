    ...
    T: AsyncRead + AsyncWrite + Unpin,
{
    ...
    pub async fn read(&mut self) -> std::io::Result<Message> {
...
mod tests {
    ...
    #[tokio::test]
    async fn client_reads_correct_message_from_socket() {
        let info_hash = (0x00..0x14).collect::<Vec<_>>();
        let their_peer_id = "-DEF123-efgh12345678";
        ...
        assert!(client.read().await.is_ok_and(|msg| msg == expected_message));
    }
}
