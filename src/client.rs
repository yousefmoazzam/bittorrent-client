...
mod tests {
    ...
    async fn return_error_if_incorrect_info_hash_in_handshake_response() {
        ...
        let our_peer_id = "-ABC123-abcd12345678";
        let their_peer_id = "-DEF123-efgh12345678";

        let expected_initial_handshake =
            Handshake::new(PSTR.to_string(), info_hash.clone(), our_peer_id.into());
        ...
        let mock_socket = tokio_test::io::Builder::new()
            ...
            .build();
        let res = Client::handshake(mock_socket, info_hash.clone(), our_peer_id).await;
